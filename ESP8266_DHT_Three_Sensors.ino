...
float sensor1_temp, sensor2_temp, sensor3_temp, sensor4_temp; // Add more if required
float sensor1_humi, sensor2_humi, sensor3_humi, sensor4_humi; // Add more if required
...
void setup(void) {
  ...
  sensor2.begin();
  sensor3.begin();
  //sensor4.begin(); // Uncomment for 4 sensors
}
